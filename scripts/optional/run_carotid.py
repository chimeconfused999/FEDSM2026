...
TRAIN = ROOT / "scripts" / "train" / "train_carotid.py"
VALIDATE = ROOT / "scripts" / "validate" / "validate_carotid.py"
...
def main():
    ...
    print("  Model:   models/trained_carotid_model.pth")
    print("  History: outputs/training_history_carotid.png")
